...
""",
    ...
    dict(
        ...
        lead="Authored initials by default; optional deterministic color and features from a local seed.",
        scripts=["../avatar.js"],
        body=f"""
{specimen('<m-vstack gap="md"><m-hstack gap="sm" wrap><m-avatar role="img" aria-label="Akonwi Ngoh">AN</m-avatar><m-avatar role="img" blobatar="akonwi" aria-label="Akonwi Ngoh">AN</m-avatar><m-avatar role="img" blobatar="ada" aria-label="Ada Lovelace">AL</m-avatar><m-avatar role="img" blobatar="grace" contained aria-label="Grace Hopper">GH</m-avatar><m-avatar role="img" blobatar="mica" style="--avatar-size: 4rem" aria-label="Mica">MI</m-avatar></m-hstack><m-hstack gap="sm"><m-avatar blobatar="akonwi-profile" aria-hidden="true">AN</m-avatar><m-vstack gap="none"><b>Akonwi Ngoh</b><small>akonwi@example.com</small></m-vstack></m-hstack></m-vstack>')}
{code('<m-avatar role="img" aria-label="Akonwi Ngoh">AN</m-avatar>' + chr(10) + '<m-avatar role="img" blobatar="akonwi" aria-label="Akonwi Ngoh">AN</m-avatar>' + chr(10) + '<m-avatar role="img" blobatar="akonwi" contained aria-label="Akonwi Ngoh">AN</m-avatar>' + chr(10) + chr(10) + '<script type="module" src="mica/avatar.js"><' + '/script>')}
<h2>Progressive fallback</h2>
<p>Initials are authored content, not generated by the module. Without
<code>avatar.js</code>, or before it loads, every example remains a complete
initials avatar. The optional module uses Blobatar's deterministic seed and
contrast-safe palette utilities locally; it makes no image or identity request.</p>
<h2>Attributes</h2>
...
<h2>Accessibility</h2>
<p>Give a standalone avatar <code>role="img"</code> and the person's name with
<code>aria-label</code>. When visible text alongside it already identifies the person, use
<code>aria-hidden="true"</code> to avoid announcing the name twice. Generated
paint is decorative; authored initials remain the semantic fallback.</p>
""",
    ),
    dict(
