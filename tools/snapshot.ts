...
const PROBES: [string, string, string[]][] = [
  ...
  ["table.shell", "#data-table-demo [data-data-table]", ["container-type", "background-color", "border-top-width"]],
  ["table.region", "#data-table-demo [data-table-region]", ["position", "overflow-x"]],
  ["table.native", "#data-table-demo table", ["table-layout", "border-collapse", "min-width"]],
  ["table.cell", "#data-table-demo td", ["padding-top", "font-size"]],
  ["table.selected", "#data-table-demo tr[data-selected] td", ["background-color"]],
  ["pagination.nav", "#data-table-demo nav", ["display", "gap"]],
  ["pagination.current", '#data-table-demo [aria-current="page"]', ["background-color", "font-weight", "min-height"]],
  ["breadcrumbs.list", "#breadcrumbs-demo ol", ["display", "flex-wrap", "column-gap", "row-gap"]],
  ["breadcrumbs.link", "#breadcrumbs-demo a", ["color", "font-size", "text-decoration-line"]],
  ["breadcrumbs.current", '#breadcrumbs-demo [aria-current="page"]', ["color", "font-weight"]],
  ["bottom.nav", "#bottom-navigation-demo nav", ["display", "gap", "padding-bottom", "border-top-width", "background-color"]],
  ["bottom.link", "#bottom-navigation-demo nav > a", ["display", "min-height", "font-size", "color"]],
  ["bottom.active", '#bottom-navigation-demo [aria-current="page"]', ["background-color", "font-weight", "border-top-width"]],
  ...
  ["command.shell", "#command-demo m-command-palette", ["display", "background-color", "border-top-width"]],
  ["command.list", "#command-demo m-command-list", ["display", "overflow-y"]],
  ["command.item", "#command-demo [data-command-item]", ["display", "font-size", "background-color"]],
  ["command.divider", "#command-demo m-command-group + m-command-group", ["border-top-width"]],
  ["card.shell", "#card-list-demo m-card", ["display", "background-color", "border-top-width"]],
  ["card.header", "#card-list-demo m-card-header", ["display", "padding-left", "gap"]],
  ["card.body", "#card-list-demo m-card-body:not([flush])", ["display", "padding-left"]],
  ...
  ["callout.warning", '#callout-demo [variant="warning"]', ["background-color", "border-top-color"]],
  ["callout.danger", '#callout-demo [variant="danger"]', ["background-color", "border-top-color"]],
  ["callout.title", '#callout-demo [variant="warning"] [data-callout-title]', ["color", "font-size", "font-weight"]],
